...
$data = file_exists($dataFile) ? json_decode(file_get_contents($dataFile), true) : ['files' => []];
$files = $data['files'];
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="flex h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 w-64 shadow-lg">
        ...
        <nav class="mt-6">
            ...
            <div class="px-6 py-2">
                <a href="admin_files.php" class="flex items-center px-4 py-2 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex-1 overflow-hidden">
        <header class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between px-6 py-4">
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Files</h2>
        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="max-w-4xl mx-auto py-10">
                <h1 class="text-3xl font-bold mb-6">All Uploaded Files</h1>
                <table class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-6 py-4 border-b"><?= htmlspecialchars($file['original_name']) ?></td>
                            <td class="px-6 py-4 border-b"><?= htmlspecialchars($file['uploaded_by']) ?></td>
                            <td class="px-6 py-4 border-b"><?= htmlspecialchars($file['upload_date']) ?></td>
                            <td class="px-6 py-4 border-b"><a href="<?= htmlspecialchars($file['path']) ?>" download class="text-blue-600">Download</a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
