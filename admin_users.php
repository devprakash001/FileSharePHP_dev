...
$data = file_exists($dataFile) ? json_decode(file_get_contents($dataFile), true) : ['users' => []];
$users = $data['users'];
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="flex h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 w-64 shadow-lg">
        ...
        <nav class="mt-6">
            ...
            <div class="px-6 py-2">
                <a href="admin_users.php" class="flex items-center px-4 py-2 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="max-w-4xl mx-auto py-10">
                ...
                <table class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-6 py-4 border-b"><?= htmlspecialchars($user['fullname']) ?></td>
                            <td class="px-6 py-4 border-b"><?= htmlspecialchars($user['email']) ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
